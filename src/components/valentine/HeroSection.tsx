      ...
      <div className="grid lg:grid-cols-2 min-h-screen">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            >
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                An unforgettable Valentine's celebration where luxury dining, live entertainment,
                and meaningful connections create memories that last beyond the night.
              </p>

              {/* Info Cards */}
              <div className="space-y-3 mb-10">
                {[
                  { icon: Calendar, text: 'Friday, February 14th, 2025 • 7:00 PM' },
                  { icon: MapPin, text: 'Exclusive Venue • Harare' },
                  { icon: Users, text: 'Singles & Couples Welcome' }
                ].map((item, i) => (
                  <motion.div
                    key={i}
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <span className="relative z-10">Secure Your Ticket - $100</span>
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-8 py-4 bg-transparent border border-[#B76E79] text-[#B76E79] rounded-lg font-medium hover:bg-[#B76E79]/10 transition-all duration-300"
                >
                  View Experience
                </motion.button>
              </div>
        ...
        <div className="relative h-[50vh] lg:h-screen">
          <div className="absolute inset-0 grid grid-cols-2 gap-1">
            {[
              'https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=800', // Red carpet with velvet ropes
              'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=800', // Luxury ballroom with chandeliers
              'https://images.unsplash.com/photo-1519225421980-715cb0215aed?q=80&w=800', // Elegant table setting with candles
              'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?q=80&w=800'  // Professional photography setup
            ].map((img, i) => (
              <motion.div
                key={i}
